...
def linear_multi_fidelity_model(x_train_hf, y_train_hf):
    #X_train, Y_train = convert_xy_lists_to_arrays([x_train_hf],[y_train_hf])

    gpy_model = GPy.models.GPRegression(x_train_hf, y_train_hf, GPy.kern.RBF(5))
    ...
    #plt.plot(x_train_hf, y_train_hf, "ro", markersize=10, label="Observations")
